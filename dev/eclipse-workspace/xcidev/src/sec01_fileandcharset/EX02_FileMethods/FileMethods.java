...
public class FileMethods {
	public static void main(String[] args) {
		...
		File tempDir =  new File("/Users/sammy/dev");
		if(!tempDir.exists())
			tempDir.mkdir();
		
		// 1. invoke file object
		File file = new File("/Users/sammy/dev");
		// 2. 파일 메서드 
		...
		File newfile1 = new File("/Users/sammy/dev/temp/abc");
		System.out.println(newfile1.mkdir());
		File newfile2 = new File("/Users/sammy/dev/temp/abc/cde");
