...
public class PrintWriterExample {
	public static void main(String[] args) {
		...
		//파일객체 생성
		File printWriter1 = new File("src/files/printWriter1.txt");
		File printWriter2 = new File("src/files/printWriter2.txt");
		File printWriter3 = new File("src/files/printWriter3.txt");
